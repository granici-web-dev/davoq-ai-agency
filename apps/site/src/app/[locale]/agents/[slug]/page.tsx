...
export async function generateMetadata({
  ...
  /* Марка не дописывается: её добавляет шаблон заголовка из макета.
     ...
     У доступного агента заголовок написан под запрос, которым его ищут.
     У остальных берём название из каталога: сочинять поисковый заголовок
     для того, чего ещё нет, — это привести людей на страницу-обещание. */
