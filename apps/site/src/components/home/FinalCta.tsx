 ...
 * Последний экран.
 *
 * Формы здесь нет намеренно: она открывается окном по кнопке. Форма,
 * развёрнутая в подвале страницы, стоит четыре поля высоты у каждого,
 * кто до неё дошёл и не собирался писать, — а собирающийся напишет
 * из любой точки страницы, кнопка есть и в шапке.
 *
    ...
    <section id="contact" className="relative isolate overflow-hidden px-6 py-section sm:px-8">
      ...
      <div className="relative mx-auto flex max-w-3xl flex-col items-center text-center">
        ...
        <div className="mt-10 flex flex-wrap items-center justify-center gap-3">
          <DemoButton>{t('primary')}</DemoButton>
